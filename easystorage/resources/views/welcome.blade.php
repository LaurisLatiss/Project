...
<html lang="{{ app()->getLocale() }}">
    ...
    <div class="container-fluid">
      <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
        <div class="container">
          <a class="navbar-brand" href="{{ url('/') }}">Easy Storage</a>
...
<div id="banner">
    <img src="{{asset('images/archive.jpg')}}" id="homepage-banner" class="img-fluid" alt="Archive">
...
<div class="container">
	<section id="what-we-do">
			<h2 class="section-title mb-2 h1">Easy Storage</h2>
				...
				<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 col-xl-4">
					<div class="card">
						<div class="card-block block-5">
							<h3 class="card-title">FUNKCIONĀLS</h3>
							<p class="card-text">Ispējams pielāgot klienta individuālām vajadzība.</p>
						</div>
					</div>
				</div>
				<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 col-xl-4">
					<div class="card">
						<div class="card-block block-6">
							<h3 class="card-title">BEZMAKSAS</h3>
							<p class="card-text">Pats labākais - mūsu pakalpojumi ir pilnībā bezmaksas!</p>
						</div>
					</div>
				</div>
			</div>
...
<!-- Footer end -->
    ...
    <script src="{{ URL::asset ('my-css/bootstrap/js/bootstrap.bundle.min.js') }}"></script>
    <script>
